...
const navigation: ReadonlyArray<{ to: string; label: string; permission?: string }> = [
  { to: '/tenants', label: 'Practices', permission: 'Permissions.Tenants.Search' },
  { to: '/users', label: 'Operators', permission: 'Permissions.Users.Search' },
];
    ...
    <div className="flex min-h-full flex-col">
      <header className="border-b border-border bg-surface">
        <div className="mx-auto flex max-w-6xl items-center gap-6 px-4 py-3">
          <span className="font-semibold tracking-tight">Dental Operator</span>
